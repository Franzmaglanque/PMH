...
import { z } from 'zod';
import { getNewImageColumns } from '@/components/Columns/New_image';
import { useNumericInputWithMaxLength } from '@/lib/inputHelpers';

// Zod schema for new image form
...
type NewImageInput = z.infer<typeof newImageSchema>;

function NewImageContent() {
    const PAGE_TYPE = 'new_image';
    const router = useRouter();
    const queryClient = useQueryClient();
    const searchParams = useSearchParams();
    const batchNumber = searchParams.get('batch_number');
    const [confirmModalOpened, setConfirmModalOpened] = useState(false);
    const [pendingFormData, setPendingFormData] = useState<NewImageInput | null>(null);
        ...
        onSuccess: (data) => {
            ...
            if (data.status) {
                ...
                if (pendingFormData) {
                    ...
                    formData.append('long_name', pendingFormData.description || '');
    ...
    const onEditSubmit = (data: NewImageInput) => {
        ...
        formData.append('long_name', data.description || '');
        formData.append('batch_number', batchNumber || '');
        formData.append('request_type', PAGE_TYPE);
    ...
    const onSubmit = (data: NewImageInput) => {
        ...
        if (!imageFile) {
            showErrorNotification(
                'Image Required',
                'Please upload an image before saving the record'
            );
            return;
        }
    ...
    const handleGoBack = () => {
        ...
        router.push('/batch?request_type=new_image');
    };
    ...
    // Barcode input helper with 13 digit limit
        ...
        <Box style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', padding: rem(20) }}>
            ...
            <Box mb="xl">
                ...
                <Group gap="xs">
                    ...
                    <Badge color="violet" variant="filled" size="sm">NEW IMAGE</Badge>
                </Group>
            </Box>
                    ...
                    <Box p="xl" style={{ backgroundColor: 'white' }}>
                        ...
                        <Grid gutter="lg">
                            <Grid.Col span={12}>
                                <Box>
                                    <Text size="sm" fw={600} mb={rem(8)} c="#495057">
                                        NEW IMAGE <span style={{ color: 'red' }}>*</span>
                                    </Text>
                                    <FileInput
                        ...
                        <Paper p="md" withBorder style={{ backgroundColor: '#f8f9fa' }}>
                            <Stack gap="xs">
                                ...
                                <Group justify="space-between">
                                    ...
                                    <Badge color="violet" variant="light">NEW IMAGE</Badge>
                                </Group>
                                <Group justify="space-between">
                            ...
                            <Stack gap="md">
                                <Box>
                                    <Text size="xs" fw={600} mb={rem(6)} c="#495057">
                                        New Image <span style={{ color: '#fa5252' }}>*</span>
                                    </Text>
                                    <FileInput
